...
st.set_page_config(page_title="Cotações — Thábata Morais", layout="wide", page_icon="🥬")
...
[data-testid="stSidebar"] { background-color: #1C231A !important; }
[data-testid="stSidebar"] p,
[data-testid="stSidebar"] span,
[data-testid="stSidebar"] small,
[data-testid="stSidebar"] .stCaption { color: #C8C9B8 !important; }
[data-testid="stSidebar"] h1,
[data-testid="stSidebar"] h2,
[data-testid="stSidebar"] h3 { color: #F3EDDF !important; }
[data-testid="stSidebar"] hr { border-color: rgba(255,255,255,0.08) !important; }
[data-testid="stSidebar"] [data-testid="stMetricValue"] { color: #F3EDDF !important; font-weight: 800 !important; }
[data-testid="stSidebar"] [data-testid="stMetricLabel"] p { color: #7A8572 !important; }
...
.stTabs [data-baseweb="tab-list"] { gap: 0 !important; background: transparent !important; }
...
.stTabs [aria-selected="true"] { color: #F26A2E !important; }
.stTabs [data-baseweb="tab-highlight"] { background: #F26A2E !important; height: 2px !important; }
[data-baseweb="tag"] {
    background-color: #3A2318 !important;
    border: 1px solid #6B3018 !important;
    border-radius: 100px !important;
}
[data-baseweb="tag"] span { color: #F26A2E !important; }
...
st.markdown("## Sistema de Cotações")

# ── Barra lateral ────────────────────────────────────────────────────────────

with st.sidebar:
    # Logo
    _logo_path = "logo_TM_creme.png"
    if os.path.exists(_logo_path):
        with open(_logo_path, "rb") as _f:
            _logo_b64 = base64.b64encode(_f.read()).decode()
        st.markdown(
            f'<img src="data:image/png;base64,{_logo_b64}" '
            f'style="width:140px;margin-bottom:24px;display:block;">',
            unsafe_allow_html=True,
        )
    else:
        st.markdown("### thábata morais")
    ...
    for nome, qtd in _forn:
        st.caption(f"**{nome}**: {qtd}")

    st.divider()
    if st.button("🔄 Recarregar tabelas"):
        st.cache_data.clear()
        st.rerun()
